...
class MyReservationScreen extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.mainView}>
          ...
          />
          <MyTitleView title={'My Reservations'} />
          {this.renderContent()}
        </View>
        <TouchableOpacity
          style={styles.searchButtonView}
          onPress={this.handleMakeNewReservation}>
          <Image
    ...
    return (
      <View style={{marginHorizontal: scale(35), marginTop: scaleVertical(12)}}>
        <TouchableOpacity
          ...
          onPress={() => this.handleMore(item, index)}>
          ...
          <View style={styles.subItemView}>
            ...
            {/*  <TouchableOpacity onPress={() => this.handleMore(item, index)}>*/}
            {/*    <Image*/}
